...
class Hospital():
    ...
    # function devuelve un array de pacientes
    def devolver_pacientes(self):
        return self.pacientes

    # funcion evalua si la cantidad de pacientes es <3 si lo es añade a una lista el nombre del paciente a la
    # habitation si no muestra un mensaje para derivar al paciente a otro hospital
...
# Objeto hospital
hospital = Hospital("HOSPITAL 1", CDoctor.dicionario_doctores, CEnfermero.dicionario_enfermeros,
                    CPaciente.lista_pacientes)
